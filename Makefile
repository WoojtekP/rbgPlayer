...
$(eval $(call PLAYER_KIND_RULES,ORTHODOXMCTS_SEMISPLITSIM,orthodoxMcts_semisplitSim,$(MCTS_COMMON) $(ORTHODOX_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
$(eval $(call PLAYER_KIND_RULES,ORTHODOXMCTS_SEMISPLITSIM_MASTSPLIT,orthodoxMcts_semisplitSim_mastsplit,$(MOVES_CONTAINER_SPLIT) $(MCTS_COMMON) $(ORTHODOX_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLITMCTS_SEMISPLITSIM_MASTSPLIT,semisplitMcts_semisplitSim_mastsplit,$(MOVES_CONTAINER_SPLIT) $(MCTS_COMMON) $(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
