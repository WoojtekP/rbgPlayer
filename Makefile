...
SEMISPLIT_MCTS := mcts_semisplit mcts_semisplit_tree
...
$(eval $(call PLAYER_KIND_RULES,ORTHODOX_MCTS_SIM_ORTHODOX,orthodox_mcts_sim_orthodox,$(MCTS_COMMON) $(ORTHODOX_MCTS) $(ORTHODOX_SIMULATOR) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLIT_MCTS_SIM_SEMISPLIT,semisplit_mcts_sim_semisplit,$(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
