...
$(eval $(call PLAYER_KIND_RULES,SEMISPLITMCTS_SEMISPLITSIM_CONTEXTMAST,semisplitMcts_semisplitSim_contextmast,$(MAST_CHOOSER) $(MOVES_TREE) $(MOVES_CONTAINER) $(MCTS_COMMON) $(SEMISPLIT_COMMON) $(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,ROLLUPMCTS_SEMISPLITSIM_CONTEXTMAST,rollupMcts_semisplitSim_contextmast,$(MAST_CHOOSER) $(MOVES_TREE) $(MOVES_CONTAINER) $(MCTS_COMMON) $(SEMISPLIT_COMMON) $(ROLLUP_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
