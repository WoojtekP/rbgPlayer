...
$(eval $(call PLAYER_KIND_RULES,ORTHODOXMCTS_ORTHODOXSIM_MAST,orthodoxMcts_orthodoxSim_mast,$(MAST_CHOOSER) $(MOVES_CONTAINER) $(MCTS_COMMON) $(ORTHODOX_MCTS) $(ORTHODOX_SIMULATOR) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLITMCTS_SEMISPLITSIM,semisplitMcts_semisplitSim,$(UNIFORM_CHOOSER) $(MCTS_COMMON) $(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
