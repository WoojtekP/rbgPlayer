...
MAST_MIX := moves_container_context $(MAST_CHOOSER) $(MOVES_TREE) $(ACTIONS_ARRAYS)
MAST_CONTEXT := $(MAST_MIX)
# RAVE
RAVE_ORTHODOX := rave_tree
RAVE_CONTEXT := $(RAVE_ORTHODOX)
RAVE_MIX := $(RAVE_ORTHODOX)
# SIMULATORS
...
$(eval $(call PLAYER_KIND_RULES,ORTHODOX_ORTHODOX_RAVE,orthodox_orthodox_rave,\
			$(ORTHODOX_MCTS) $(ORTHODOX_SIMULATOR) $(UNIFORM_CHOOSER) $(RAVE_ORTHODOX) $(COMMON) $(GEN_DIR)))

$(eval $(call PLAYER_KIND_RULES,ORTHODOX_ORTHODOX_MAST_RAVE,orthodox_orthodox_mast_rave,\
			$(ORTHODOX_MCTS) $(ORTHODOX_SIMULATOR) $(MAST_ORTHODOX) $(RAVE_ORTHODOX) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,ORTHODOX_SEMISPLIT_MASTSPLIT_RAVE,orthodox_semisplit_mastsplit_rave,\
			$(ORTHODOX_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_SPLIT) $(RAVE_ORTHODOX) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLIT_SEMISPLIT_RAVE,semisplit_semisplit_rave,\
			$(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(UNIFORM_CHOOSER) $(RAVE_ORTHODOX) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLIT_SEMISPLIT_MAST_RAVE,semisplit_semisplit_mast_rave,\
			$(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_ORTHODOX) $(RAVE_ORTHODOX) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLIT_SEMISPLIT_MASTSPLIT_RAVE,semisplit_semisplit_mastsplit_rave,\
			$(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_SPLIT) $(RAVE_ORTHODOX) $(COMMON) $(GEN_DIR)))
