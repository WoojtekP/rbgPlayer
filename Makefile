...
$(eval $(call PLAYER_KIND_RULES,ORTHODOXMCTS_ORTHODOXSIM_RAVE,orthodoxMcts_orthodoxSim_rave,$(UNIFORM_CHOOSER) $(MCTS_COMMON) $(ORTHODOX_MCTS) $(ORTHODOX_SIMULATOR) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,ORTHODOXMCTS_ORTHODOXSIM_MASTSPLIT,orthodoxMcts_orthodoxSim_mastsplit,$(MAST_CHOOSER) $(MOVES_CONTAINER_SPLIT) $(MCTS_COMMON) $(ORTHODOX_MCTS) $(ORTHODOX_SIMULATOR) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,ORTHODOXMCTS_SEMISPLITSIM_MASTSPLIT,orthodoxMcts_semisplitSim_mastsplit,$(MAST_CHOOSER) $(MOVES_CONTAINER_SPLIT) $(MCTS_COMMON) $(ORTHODOX_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLITMCTS_SEMISPLITSIM_MASTSPLIT,semisplitMcts_semisplitSim_mastsplit,$(MAST_CHOOSER) $(MOVES_CONTAINER_SPLIT) $(MCTS_COMMON) $(SEMISPLIT_COMMON) $(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
$(eval $(call PLAYER_KIND_RULES,SEMISPLITMCTS_SEMISPLITSIM_MASTCONTEXT,semisplitMcts_semisplitSim_mastcontext,$(MAST_CHOOSER) $(MOVES_TREE) $(MOVES_CONTAINER) $(MCTS_COMMON) $(SEMISPLIT_COMMON) $(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLITMCTS_ORTHODOXSIM_MASTSPLIT,semisplitMcts_orthodoxSim_mastsplit,$(MAST_CHOOSER) $(MOVES_CONTAINER_SPLIT) $(MCTS_COMMON) $(SEMISPLIT_COMMON) $(SEMISPLIT_MCTS) $(ORTHODOX_SIMULATOR) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,ROLLUPMCTS_SEMISPLITSIM_MASTCONTEXT,rollupMcts_semisplitSim_mastcontext,$(MAST_CHOOSER) $(MOVES_TREE) $(MOVES_CONTAINER) $(MCTS_COMMON) $(SEMISPLIT_COMMON) $(ROLLUP_MCTS) $(SEMISPLIT_SIMULATOR) $(COMMON) $(GEN_DIR)))
