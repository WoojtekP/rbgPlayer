...
$(eval $(call PLAYER_KIND_RULES,ORTHODOX_SEMISPLIT_MASTCONTEXT,orthodox_semisplit_mastcontext,\
			$(ORTHODOX_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_CONTEXT) $(COMMON) $(GEN_DIR)))

$(eval $(call PLAYER_KIND_RULES,ORTHODOX_SEMISPLIT_MASTCONTEXT,orthodox_semisplit_mastcontext_tgrave,\
			$(ORTHODOX_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_CONTEXT) $(TGRAVE_ORTHODOX) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,ORTHODOX_SEMISPLIT_MASTMIX,orthodox_semisplit_mastmix,\
			$(ORTHODOX_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_MIX) $(COMMON) $(GEN_DIR)))

$(eval $(call PLAYER_KIND_RULES,ORTHODOX_SEMISPLIT_MASTMIX_TGRAVE,orthodox_semisplit_mastmix_tgrave,\
			$(ORTHODOX_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_MIX) $(TGRAVE_ORTHODOX) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLIT_SEMISPLIT_MASTSPLIT_RAVEMIX,semisplit_semisplit_mastsplit_ravemix,\
			$(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_SPLIT) $(RAVE_MIX) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLIT_SEMISPLIT_MASTCONTEXT_RAVEMIX,semisplit_semisplit_mastcontext_ravemix,\
			$(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_CONTEXT) $(RAVE_MIX) $(COMMON) $(GEN_DIR)))

$(eval $(call PLAYER_KIND_RULES,SEMISPLIT_SEMISPLIT_MASTMIX_TGRAVE,semisplit_semisplit_mastmix_tgrave,\
			$(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_MIX) $(TGRAVE_SPLIT) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLIT_SEMISPLIT_MASTMIX_RAVEMIX,semisplit_semisplit_mastmix_ravemix,\
			$(SEMISPLIT_MCTS) $(SEMISPLIT_SIMULATOR) $(MAST_MIX) $(RAVE_MIX) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,SEMISPLIT_ORTHODOX_MASTCONTEXT,semisplit_orthodox_mastcontext,\
			$(SEMISPLIT_MCTS) $(ORTHODOX_SIMULATOR) $(MAST_CONTEXT) $(COMMON) $(GEN_DIR)))

$(eval $(call PLAYER_KIND_RULES,SEMISPLIT_ORTHODOX_RAVECONTEXT,semisplit_orthodox_ravecontext,\
			$(SEMISPLIT_MCTS) $(ORTHODOX_SIMULATOR) $(UNIFORM_CHOOSER) $(RAVE_CONTEXT) $(COMMON) $(GEN_DIR)))
...
$(eval $(call PLAYER_KIND_RULES,ROLLUP_SEMISPLIT_RAVECONTEXT,rollup_semisplit_ravecontext,\
			$(ROLLUP_MCTS) $(SEMISPLIT_SIMULATOR) $(UNIFORM_CHOOSER) $(RAVE_CONTEXT) $(COMMON) $(GEN_DIR)))

$(eval $(call PLAYER_KIND_RULES,ROLLUP_ORTHODOX,rollup_orthodox,\
			$(ROLLUP_MCTS) $(ORTHODOX_SIMULATOR) $(UNIFORM_CHOOSER) $(COMMON) $(GEN_DIR)))

$(eval $(call PLAYER_KIND_RULES,ROLLUP_ORTHODOX_MASTCONTEXT,rollup_orthodox_mastcontext,\
			$(ROLLUP_MCTS) $(ORTHODOX_SIMULATOR) $(MAST_CONTEXT) $(COMMON) $(GEN_DIR)))

$(eval $(call PLAYER_KIND_RULES,ROLLUP_ORTHODOX_RAVECONTEXT,rollup_orthodox_ravecontext,\
			$(ROLLUP_MCTS) $(ORTHODOX_SIMULATOR) $(UNIFORM_CHOOSER) $(RAVE_CONTEXT) $(COMMON) $(GEN_DIR)))
